...
compile_go_fuzzer github.com/Furisto/runc/libcontainer/system FuzzUIDMap id_map_fuzzer linux,gofuzz
compile_go_fuzzer github.com/Furisto/runc/libcontainer/user FuzzUser user_fuzzer
compile_go_fuzzer github.com/Furisto/runc/libcontainer/configs FuzzUnmarshalJSON configs_fuzzer
